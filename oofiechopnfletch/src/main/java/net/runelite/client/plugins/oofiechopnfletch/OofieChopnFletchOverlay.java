...
@Slf4j
@Singleton
class OofieChopnFletchOverlay extends OverlayPanel
{
    private final Client client;
    private final OofieChopnFletchPlugin plugin;
    private final OofieChopnFletchConfig config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    private OofieChopnFletchOverlay(final Client client, final OofieChopnFletchPlugin plugin, final OofieChopnFletchConfig config)
    {
        super(plugin);
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "Oofie's Chop n Fletch overlay"));
    }
    ...
    public Dimension render(Graphics2D graphics)
    {
        ...
        tableDelayComponent.addRow("Sleep delay:", OofieChopnFletchPlugin.sleepLength + "ms");
        ...
        if (!tableComponent.isEmpty())
        {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                .text("Oofie's Chop n Fletch 0.0.1")
