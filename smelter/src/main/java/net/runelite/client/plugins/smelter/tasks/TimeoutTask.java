...
public class TimeoutTask extends Task
{
	...
	{
		ConditionTimeout conditionTimeout = SmelterPlugin.conditionTimeout;
		...
		return SmelterPlugin.timeout > 0;
	}
	...
	{
		SmelterPlugin.conditionTimeout = null;
		SmelterPlugin.timeoutFinished = true;
	}
	...
	public void onGameTick(GameTick event)
	{
		...
		if (SmelterPlugin.timeout > 0)
		{
			SmelterPlugin.timeout--;
			if (SmelterPlugin.timeout == 0)
			{
				SmelterPlugin.timeoutFinished = true;
			}
