...
public enum BarType {
    ...
    ADAMANTITE("Adam",  17694741,21, ItemID.ADAMANTITE_BAR,  ItemID.ADAMANTITE_ORE,      ItemID.COAL, 4),
    RUNITE("Runite",    17694742,22, ItemID.RUNITE_BAR,      ItemID.RUNITE_ORE,          ItemID.COAL, 3);
    ///  oreAmt = firstOre for testing purposing for now                                 FIRST ORE                   SECOND ORE
