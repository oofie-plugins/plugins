...
project.extra["GithubUrl"] = "https://github.com/oofie-plugins/oofie-plugins"
...
subprojects {
    ...
    dependencies {
        ...
        implementation(group = "org.mongodb", name = "mongodb-driver-core", version = "4.2.0")
        implementation(group = "org.mongodb", name = "bson", version = "4.2.0")
