...
@Slf4j
@Singleton
class CatGrowerOverlay extends OverlayPanel
{
	private final Client client;
	private final CatGrowerPlugin plugin;
	private final CatGrowerConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private CatGrowerOverlay(final Client client, final CatGrowerPlugin plugin, final CatGrowerConfig config)
	{
		super(plugin);
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		tableDelayComponent.addRow("Sleep delay:", CatGrowerPlugin.sleepLength + "ms");
